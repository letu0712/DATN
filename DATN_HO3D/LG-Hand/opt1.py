...
class opts():
    ...
    def init(self):
        ...
        #                     Dataset options
        # ===============================================================
        self.parser.add_argument('--dataset', type=str, default='FPHAB', help='dataset')
        self.parser.add_argument('-k', '--keypoints', default='GT', type=str, metavar='NAME',
                            help='2D detections to use {gt||cpn_ft_h36m_dbb}')
        self.parser.add_argument( '--type3d', default='GT', type=str, metavar='NAME',)
        ...
        self.parser.add_argument('--root_path', type=str, default='data/', help='dataset root path')
        ...
        self.parser.add_argument('--co_dist', type=float, default=0)
        self.parser.add_argument('--workers', type=int, default=6, help='number of data loading workers')

        #LeTu
        self.parser.add_argument('--co_temporal', type=float, default=0)
        self.parser.add_argument('--co_angle', type=float, default=0)
        self.parser.add_argument("--co_angle_pred_gt", type=float, default=0)
        self.parser.add_argument("--co_direction", type=float, default=0)
        ...
        self.parser.add_argument('--layout', type=str, default='fphab_gt', help='dataset used')
        ...
        self.parser.add_argument('--n_joints', type=int, default=21, help='number of joints, 16 for human body 21 for hand pose')
        self.parser.add_argument('--out_joints', type=int, default=21, help='number of joints, 16 for human body 21 for hand pose')
    ...
    def parse(self):
        ...
        if self.opt.dataset == 'FPHAB':
            # self.opt.subjects_train = 'S1,S5,S6,S7,S8'
            # self.opt.subjects_test = 'S9,S11'
            # self.opt.subjects_train = 'Subject_2,Subject_6,Subject_4,Subject_3'
            # self.opt.subjects_test = 'Subject_1,Subject_5'
            # self.opt.subjects_train = 'Subject_2'
            # self.opt.subjects_test = 'Subject_1'
            self.opt.subjects_train = 'Subject_1,Subject_2,Subject_6,Subject_4,Subject_3,Subject_5'
            self.opt.subjects_test = 'Subject_1,Subject_2,Subject_6,Subject_4,Subject_3,Subject_5'            



        if self.opt.keypoints == 'pre59':
            self.opt.save_dir += 'pre/'
            self.opt.layout = 'fphab_gt'
